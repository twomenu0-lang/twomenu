...
List<WalkModel> getWalkData() {
  ...
  featured.add(WalkModel.info(ic_halloween_walk1, "Welcome to Twomenu Shop", "Lorem Ipsum is simply dummy text of the printing and typesetting industry."));
...
List<WalkModel> getChristmasWalkData() {
  List<WalkModel> featured = [];
  featured.add(WalkModel.info(ic_christmas_walk1, "Welcome to Twomenu Shop", "Lorem Ipsum is simply dummy text of the printing and typesetting industry."));
