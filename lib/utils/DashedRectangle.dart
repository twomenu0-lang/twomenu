...
class DashedRectangle extends StatelessWidget {
  ...
  DashedRectangle({this.color = Colors.black, this.strokeWidth = 1.0, this.gap = 5.0});
...
class DashRectPainter extends CustomPainter {
  ...
  Path getDashedPath({
    ...
    while (currentPoint.x <= b.x && currentPoint.y <= b.y) {
      shouldDraw ? path.lineTo(currentPoint.x as double, currentPoint.y as double) : path.moveTo(currentPoint.x as double, currentPoint.y as double);
