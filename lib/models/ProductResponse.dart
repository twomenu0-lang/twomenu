...
// ✅ Images class مع إضافة thumbnail
class Images {
  int? id;
  String? dateCreated;
  String? dateModified;
  String? src;
  String? thumbnail; // ✅ إضافة جديدة لتسريع تحميل الصور
  String? name;
  String? alt;
  int? position;
  ...
  Images.fromJson(Map<String, dynamic> json) {
    ...
    dateModified = json['date_modified'];
    src = json['src'];
    thumbnail = json['thumbnail']; // ✅ قراءة الـ thumbnail من الـ API
    name = json['name'];
    alt = json['alt'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['date_modified'] = this.dateModified;
    data['src'] = this.src;
    data['thumbnail'] = this.thumbnail; // ✅ حفظ الـ thumbnail
    data['name'] = this.name;
    data['alt'] = this.alt;
